...
This is the detailed implementation reference retained from the original README. For verified setup, current limitations, and the consumer contract, start with [the README](../README.md).
...
Detailed API contract for consuming agents: [`docs/newsletter-json-api.md`](./newsletter-json-api.md)

Short subscription handoff for agent consumers: [`docs/agent-subscription-instructions.md`](./agent-subscription-instructions.md)
...
Standalone policy document: [`docs/content-inclusion-policy.md`](./content-inclusion-policy.md)
...
For a dedicated machine-facing reference that consolidates endpoint definitions, schema details, versioning rules, and example requests and responses, see [`docs/newsletter-json-api.md`](./newsletter-json-api.md).
